...
import com.eastx.sap.trader.core.data.source.AbstractDataSource;
import com.eastx.sap.trader.core.data.source.DataSource;
import com.eastx.sap.trader.core.data.source.FlatFileDataSource;
import com.eastx.sap.trader.core.data.source.PreCachedDataSource;
...
public class MockExchangeFactory implements DataFactory {
    ...
    public DataSource createSource() {
        class EventEnableSource extends AbstractDataSource.Proxy {
            EventEnableSource() {
                super("CsvEvent", new PreCachedDataSource(fileName, 1));
            }
        }
